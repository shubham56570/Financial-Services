...
<div id="divright" style="overflow-x:auto;">
    ...
    <form:form action="/postTradingAccount" method="post" modelAttribute="submitTradingAttri">
        <table id="tbl" >
        <tr>
            ...
            <tr>
                <td></td>
                <td></td>
                <td><a href="<c:out value="/deleteTradingvalues/{trading_id}"/>" " > Delete Permanent</a></td>
                <td id="reset"><input type="reset" value="Temporary Reset">
                <input type="submit" value="Submit & Next"><td> 
            </tr>
        </table>
    </form:form>
</div>
