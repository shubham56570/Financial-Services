...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/css/homemore.css" />
  </head>
  ...
  <body>
    ...
    <header>
      ...
      <nav class="navbar">
        <ul>
          ...
          <li><a href="/views/financialservices.jsp">FINANCIAL SERVCICES</a></li>
            <div class="dropdown">
    ...
    <section class="home" id="home">
      <div class="content">
        ...
        <a href="/userlogin"><button class="btn">See More</button></a>
      </div>
    ...
    <div class="footer">
      <h1>our Mantra is "Generate Alpha Reduce Risk"</h1>
        ...
        <div class="footer-div4">
          <h2>Soltion</h2><br/>
          <a href="#">Data Soltion </a><br/>
          <a href="#">Research Soltion </a><br/>
          <a href="#">Bussines Soltion </a><br/>
          <a href="#">Risk Soltion </a>
        </div>
