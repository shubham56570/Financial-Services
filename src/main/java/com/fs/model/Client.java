...
public class Client {
	...
	public String getCl_pre_date() {
		return cl_pre_date;
	}

	public void setCl_pre_date(String cl_pre_date) {
		this.cl_pre_date = cl_pre_date;
	}
	...
	public String toString() {
		return "Client [client_id=" + client_id + ", cl_pre_date=" + cl_pre_date + ", cl_Org=" + cl_Org
				+ ", cl_Buss_name=" + cl_Buss_name + ", cl_legal_name=" + cl_legal_name + ", cl_email=" + cl_email
				+ ", cl_mobile=" + cl_mobile + ", cl_pan=" + cl_pan + ", cl_address=" + cl_address + ", cl_gstin="
				+ cl_gstin + "]";
	}

	public Client(long client_id, String cl_pre_date, String cl_Org, String cl_Buss_name, String cl_legal_name,
			String cl_email, String cl_mobile, String cl_pan, String cl_address, String cl_gstin) {
		super();
		this.client_id = client_id;
		this.cl_pre_date = cl_pre_date;
		this.cl_Org = cl_Org;
